...
public class Start {
	...
	private static void run(){
		...
		System.out.println("Будет затрачено топлива - "+calculateTotalSumm(ras,zatrat));
		System.out.println("Стоимость поездки - "+calculateOverPaid(calculateTotalSumm(ras,zatrat), cena));
	}
